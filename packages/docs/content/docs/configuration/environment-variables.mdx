...
| `BUILTIN_SCRAPE_TITLE_LIMIT`                        | Scrape › Title Limit                          | number  | `6`                     | Maximum alternative titles used per scrape.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `BUILTIN_SCRAPE_SERIES_TITLE_ONLY_QUERY`            | Scrape › Series Title Only Query              | boolean | `true`                  | Also search series by title alone, with no season or episode. Finds complete-series and multi-season packs, whose names carry neither; the episode is then selected from the pack's file list. Costs one extra query per title per indexer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
